...
st.set_page_config(
    page_title="Dashboard Temperatur, Tekanan Atmosfer Wilayah Nongzhanguan periode 2013 - 2017",
    layout="wide"
)

path = "main_data.csv"
Nongzhanguan= pd.read_csv(path)
output = "data.csv"
Nongzhanguan.to_csv(output, index=False)
...
st.title("Dashboard Temperatur dan Tekanan Atmosfer")
...
tab1, tab2, tab3 = st.tabs(["Tahunan", "Distribusi", "Analisis Musiman"])

with tab1:
    st.subheader("Tahunan Temperatur dan Tekanan Atmosfer")
    ...
    plt.title('Rata-rata Temperatur dan Tekanan Atmosfer Per Tahun', fontsize=14)
    st.pyplot(fig)
